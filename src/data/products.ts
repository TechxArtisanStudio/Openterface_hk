...
export const products: Record<string, Product> = {
  keymod: {
    ...
    swFeatures: [
      ...
      { title: '跨平台', description: '通過 Openterface 應用，支持 Android、iPadOS 和桌面端主機。' },
  ...
  'kvm-go': {
    ...
    swFeatures: [
      { title: 'Openterface Qt 應用', description: '跨平台控制端，支持 Windows、macOS 和 Linux。' },
  ...
  minikvm: {
    ...
    swFeatures: [
      { title: 'Qt / macOS / Android 應用', description: '適配主流平台的高性能原生應用。' },
    ...
    useCases: ['個人實驗室管理', '開發工作站並排控制', 'IT 工作台故障排除'],
    docLinks: [
